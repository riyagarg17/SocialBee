        ...
        return (
            <>
                ...
                <form className="signupForm" onSubmit={this.handleSubmit}>
                    ...
                    <input type="text" name="fullName" className="form-control" placeholder="Full Name" onChange={this.handleChange} value={this.state.fullName} />
                    ...
                    <button className="btn btn-primary btn-block mb-2" id="signup-btn">Sign Up</button>
                </form>
            </>
        )
    }
